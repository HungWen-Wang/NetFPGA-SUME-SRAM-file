...
create_ip -name mig_7series -vendor xilinx.com -library ip -version 4.0 -module_name mig_7a_0
set_property -dict [list CONFIG.XML_INPUT_FILE {/root/SRAM_NetFPGA-SUME-live/projects/mig_a.prj} CONFIG.RESET_BOARD_INTERFACE {Custom} CONFIG.MIG_DONT_TOUCH_PARAM {Custom} CONFIG.BOARD_MIG_PARAM {Custom}] [get_ips mig_7a_0]
generate_target {instantiation_template} [get_files /root/SRAM_NetFPGA-SUME-live/projects/reference_router/hw/project/reference_router.srcs/sources_1/ip/mig_7a_0/mig_7a_0.xci]
generate_target all [get_files  /root/SRAM_NetFPGA-SUME-live/projects/reference_router/hw/project/reference_router.srcs/sources_1/ip/mig_7a_0/mig_7a_0.xci]
catch { config_ip_cache -export [get_ips -all mig_7a_0] }
export_ip_user_files -of_objects [get_files /root/SRAM_NetFPGA-SUME-live/projects/reference_router/hw/project/reference_router.srcs/sources_1/ip/mig_7a_0/mig_7a_0.xci] -no_script -sync -force -quiet
create_ip_run [get_files -of_objects [get_fileset sources_1] /root/SRAM_NetFPGA-SUME-live/projects/reference_router/hw/project/reference_router.srcs/sources_1/ip/mig_7a_0/mig_7a_0.xci]
launch_runs -jobs 2 mig_7a_0_synth_1
export_simulation -of_objects [get_files /root/SRAM_NetFPGA-SUME-live/projects/reference_router/hw/project/reference_router.srcs/sources_1/ip/mig_7a_0/mig_7a_0.xci] -directory /root/SRAM_NetFPGA-SUME-live/projects/reference_router/hw/project/reference_router.ip_user_files/sim_scripts -ip_user_files_dir /root/SRAM_NetFPGA-SUME-live/projects/reference_router/hw/project/reference_router.ip_user_files -ipstatic_source_dir /root/SRAM_NetFPGA-SUME-live/projects/reference_router/hw/project/reference_router.ip_user_files/ipstatic -lib_map_path [list {modelsim=/root/SRAM_NetFPGA-SUME-live/projects/reference_router/hw/project/reference_router.cache/compile_simlib/modelsim} {questa=/root/SRAM_NetFPGA-SUME-live/projects/reference_router/hw/project/reference_router.cache/compile_simlib/questa} {ies=/root/SRAM_NetFPGA-SUME-live/projects/reference_router/hw/project/reference_router.cache/compile_simlib/ies} {vcs=/root/SRAM_NetFPGA-SUME-live/projects/reference_router/hw/project/reference_router.cache/compile_simlib/vcs} {riviera=/root/SRAM_NetFPGA-SUME-live/projects/reference_router/hw/project/reference_router.cache/compile_simlib/riviera}] -use_ip_compiled_libs -force -quiet
